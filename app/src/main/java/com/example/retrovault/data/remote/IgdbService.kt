...
object IgdbService {
    ...
    suspend fun search(title: String, platformId: String? = null): List<IgdbGame> {
        ...
        val igdbPlatformId = platformId?.let { getIgdbPlatformId(it) }
        
        val platformFilter = if (igdbPlatformId != null) " & platforms = ($igdbPlatformId)" else ""
        
        val bodyString = "search \"$escapedTitle\"; fields $commonFields; where version_parent = null $platformFilter; limit 20;"
